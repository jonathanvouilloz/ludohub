...
vi.mock('$lib/server/services/public-api.js', () => ({
  getPublicNewsDetailByLudoSlug: getDetail,
}))
...
describe('GET /api/public/v1/[ludo]/news/[slug]', () => {
  it('répond 404/no-store pour un brouillon, un slug inconnu ou une mauvaise cible', async () => {
    getDetail.mockResolvedValueOnce(null)
    const request = new Request('https://api.test/api/public/v1/demo/news/inconnue')
