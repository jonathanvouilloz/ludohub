...
import { getPublicNewsDetailByLudoSlug } from '$lib/server/services/public-api.js'
...
export const GET: RequestHandler = async ({ params, request, url }) => {
  ...
  const payload = await getPublicNewsDetailByLudoSlug(params.ludo, params.slug, site)
  if (!payload) {
