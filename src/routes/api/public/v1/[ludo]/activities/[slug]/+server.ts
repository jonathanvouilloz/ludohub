...
import { getPublicActivityDetailByLudoSlug } from '$lib/server/services/public-api.js'
...
export const GET: RequestHandler = async ({ params, request, url }) => {
  ...
  const payload = await getPublicActivityDetailByLudoSlug(params.ludo, params.slug, site)
  if (!payload) {
