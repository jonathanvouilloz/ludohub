...
import { getArchivedPublicActivitiesByLudoSlug } from '$lib/server/services/public-api.js'
...
export const GET: RequestHandler = async ({ params, request, url }) => {
  ...
  const payload = await getArchivedPublicActivitiesByLudoSlug(params.ludo, site, limit)
  if (!payload) {
