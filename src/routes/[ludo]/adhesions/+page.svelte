    ...
    <section class="panel configuration" aria-labelledby="configuration-title">
      ...
      <form method="POST" action="?/configuration" class="configuration-form">
        ...
        <div class="input-grid">
          ...
          <div class="field"><Label for="family-max-members">Nombre de membres maximum</Label><Input id="family-max-members" name="maxMembers" type="number" min="1" max="50" value={config.maxMembers} required /><p class="hint">Responsable compris.</p></div>
